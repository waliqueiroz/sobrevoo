...
// GeoDataService.
func executeGeoDataRegisterCommand(t *testing.T, geoDataService application.GeoDataService, args ...string) (stdout string, err error) {
	t.Helper()

	cmd := cli.NewGeoDataRegisterCommand(geoDataService)
